    ...
    return (
      ...
      >
        ...
        <div className="max-w-[75%]">
          <div
            className={`inline-flex max-w-full items-end gap-1 rounded-2xl px-3 py-1 break-all ${bubbleClasses}`}
          >
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div>
          <div
            className={`mt-1 inline-flex max-w-full items-end gap-1 rounded-2xl px-3 py-1.5 break-all ${bubbleClasses}`}
          >
            <span className="text-[13.5px] leading-relaxed">
              {renderTextWithLinks(text)}
            </span>
