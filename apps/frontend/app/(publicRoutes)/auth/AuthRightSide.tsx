...
import { layerAnimation } from "@/app/_animations/authAnimation";
import { staggerChildVariants } from "@/app/_animations/smallAnimations";
    ...
    >
      ...
      >
        <div className="absolute z-10">
          <MotionComponent
            className="h-24 w-1200 -rotate-45 bg-gray-900"
            id="line1"
          />
          <MotionComponent
            className="h-24 w-1200 -rotate-45 bg-gray-900"
        ...
        <div className="absolute top-25 -left-10 z-20 w-80 -rotate-45 overflow-hidden">
          <MotionComponent
            className="hidden h-full w-full translate-x-full items-center gap-80"
            id="headingSlider"
          >
        ...
        <div>
          <MotionComponent
            className="hidden w-full translate-x-full"
            id="videoSlider"
          >
            <VideoPlayer
              id="video1"
