  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-16">
      ...
      <section className="mb-8">
        ...
        <p className="leading-relaxed text-gray-600">
          You may use PixelSync for lawful purposes only. You are responsible
          for all content you create and share through the platform.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="leading-relaxed text-gray-600">
          PixelSync is provided &quot;as is&quot; without warranties of any
