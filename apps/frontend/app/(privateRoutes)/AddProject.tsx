    ...
    <div>
      <Modal>
        <Modal.Open opens="addProject">
          <button className="bg-surface hover:bg-surface/80 inline-flex h-12 w-12 cursor-pointer items-center justify-center rounded-2xl text-gray-500 transition-all hover:rounded-xl hover:text-white">
        ...
        <Modal.Window name="addProject">
          <div className="flex w-96 flex-col gap-4 p-2">
            ...
            <div className="border-border border-t pt-4">
              ...
              <button className="border-border hover:bg-surface flex w-full cursor-pointer items-center justify-center gap-2 rounded-lg border px-4 py-2.5 text-sm font-medium text-gray-300 transition-colors">
