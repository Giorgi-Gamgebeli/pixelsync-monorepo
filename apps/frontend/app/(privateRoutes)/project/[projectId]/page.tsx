    ...
    <div className="scrollbar-thin flex-1 overflow-y-auto p-8">
      ...
      {rooms.length === 0 ? (
        ...
        <div className="flex flex-col items-center justify-center py-20">
          <div className="bg-surface mb-4 flex h-16 w-16 items-center justify-center rounded-2xl">
            <ClientIcon
              icon="mdi:artboard"
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {rooms.map((room) => (
            <Link
              ...
              className="group border-border bg-secondary/50 hover:border-border hover:bg-secondary rounded-xl border p-1 transition-all"
            >
              {/* Canvas preview placeholder */}
              <div className="bg-surface/50 flex h-36 items-center justify-center rounded-lg">
                <ClientIcon
                  icon="mdi:artboard"
          ...
          <button
            ...
            className="border-border hover:bg-secondary/30 flex h-full min-h-[12rem] cursor-pointer flex-col items-center justify-center rounded-xl border border-dashed bg-transparent p-4 text-gray-500 transition-all hover:border-gray-500 hover:text-gray-300"
          >
