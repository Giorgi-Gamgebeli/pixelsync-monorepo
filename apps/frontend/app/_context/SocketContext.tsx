...
import { ServerToClientEvents, ClientToServerEvents, UserStatus } from "@repo/types";
...
export function useUserStatus(userId: string, serverStatus?: UserStatus): UserStatus {
